...
# Load the data
df = pd.read_csv('./logs_10000_500/combined_file_ATP_made.csv')  # Replace with your actual file path

# df = df.apply(pd.to_numeric, errors='coerce').fillna(0)

# Calculate the new column
# df['Phi2*PSII_antenna_size*100'] = df['Phi2'] * df['PSII_antenna_size'] * 100
# df['Phi2*PSII_antenna_size*ratio_absorb*500'] = df['Phi2'] * df['PSII_antenna_size']*df['ratio_absorb'] * 500
...
df.to_csv('./logs_10000_500/combined_file_ATP_made.csv', index=False)
