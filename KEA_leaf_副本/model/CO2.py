...
# Load the data
file_path = './logs_copy_1/2000_ATP_made.csv'  # Replace with your actual file path
...
output_path = './logs_copy_1/2000_CO2.csv'  # Replace with your desired output file path
