...
class FrozenClass(object):
    ...
    def as_tuple(self):
        c=(self.ratio_absorb, self.LIGHT,self.pKreg, self.max_PSII, self.kQA, self.max_b6f, self.lumen_protons_per_turnover, self.light_per_L,
    ...
    def as_dictionary(self):
        d={'ratio_absorb':self.ratio_absorb,'LIGHT':self.LIGHT, 'pKreg':self.pKreg, 'max_PSII':self.max_PSII,'kQA': self.kQA, 'max_b6f': self.max_b6f, 
